...
class ColorsManager {
  ...
  static const Color mainBlue = Color(0xFF44ADC7); // Blue from the logo
  static const Color mainGreen = Color(0xFF5DBD52); // Green from the logo
  static const Color backGreen = Color(0xFFEDFFEB); // Green faded from the logo
}
